    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'call_center_username', 
                    name: 'call_center_username',
                        class: 'text-center', searchable: true, orderable: false, width: '50px'  
                },
                { data: 'call_center_browser', 
                    name: 'call_center_browser',
                        class: 'text-left info', searchable: true, orderable: false, width: '50px'  
                },
                { data: 'call_center_text', 
                    name: 'call_center_text',
                        class: 'text-left info', searchable: true, orderable: false, width: '100%'  
                },
                { data: 'call_center_visitor', 
                    name: 'call_center_visitor',
                        class: 'text-left info', searchable: true, orderable: false, width: '50px'  
                },           
                { data: 'call_center_created_at', 
                    name: 'call_center_created_at',
