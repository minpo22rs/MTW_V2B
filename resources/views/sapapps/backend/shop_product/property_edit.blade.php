                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="wizardb">
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$ref_id.'/property/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                <input type="radio" name="property_active" value="1" data-bv-field="property_active" 
                                                                                {{ old('property_active') == '1' ? 'checked' : ($rec->property_active == '1' ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                <input type="radio" name="property_active" value="0" data-bv-field="property_active" 
                                                                                {{ old('property_active') == '0' ? 'checked' : ($rec->property_active == '0' ? 'checked' : '') }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="property_sort" type="text" class="form-control" data-toggle="tooltip" data-original-title="ใส่เลขเพื่อเรียงลำดับ 1 - 99" data-placement="left"
                                                                    value="{{ old('property_sort') ? old('property_sort') : $rec->property_sort }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">Property</label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="property_content" class="form-control" value="{{ old('property_content') ? old('property_content') : $rec->property_content }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">คุณสมบัติ</label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="property_content_th" class="form-control" value="{{ old('property_content_th') ? old('property_content_th') : $rec->property_content_th }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        /////////////// Fixed ///////////////////////
        window.back('{!! url("backend/$url/$ref_id/property") !!}');
