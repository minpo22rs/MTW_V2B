                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="wizardb">
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$ref_id.'/more')}}" method="POST" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('more_active') == '1' ? 'checked' : (!old('more_active') ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{  old('more_active') && old('more_active') == '0' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="more_type" class="form-control">
                                                                        {!! App\Model\front_shop::more_type_option_html( old('more_type') ) !!} 
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="more_topic" type="text" class="form-control" value="{{ old('more_topic') }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="more_content" class="form-control">{!! old('more_content') !!}</textarea>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <h3>Details TH</h3>
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="more_topic_th" type="text" class="form-control" value="{{ old('more_topic_th') }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="more_content_th" class="form-control">{!! old('more_content_th') !!}</textarea>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <h3>more</h3>
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">more <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <img  name="more_img_name" style="max-height:150px; max-width:100%; display:block;" class="m-b-5">
                                                                    <input name="more_img_name" type="file"  class="form-control img required" data-toggle="tooltip" data-original-title="เลือกไฟล์ภาพจากในเครื่อง ขนาดภาพ 1600 x 558px เพื่อให้ภาพแสดงผลได้ถูกต้อง" data-placement="left">
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
