                                        ...
                                        <table id="data-table_{{$url}}" class="table table-bordered table-hover table-striped table-condensed nowrap">
                                            ...
                                            <!--<tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><button class="btn btn-mat btn-success btn-mini active">On</button></td>
                                                    <td class="text-center"><input type="text" class="form-control w-50" value="1"></td>
                                                    <td><img src="{{ asset('public/frontend/images_system/img_slidehome_1.jpg') }}" style="width:300px;"></td>
                                                    <td>Special Trend For Books</td>
                                                    <td>Online<span>Book</span> Store</td>
                                                    <td>Shop now!</td>
                                                    <td>https://www.satapornbook.co.th/contents</td>
                                                </tr>
                                                <tr>
                                                    <td><input type="checkbox" class="form-control"></td>
                                                    <td class="text-center"><button class="btn btn-mat btn-danger btn-mini active">Off</button></td>
                                                    <td class="text-center"><input type="text" class="form-control w-50" value="2"></td>
                                                    <td><img src="{{ asset('public/frontend/images_system/img_slidehome_1.jpg') }}" style="width:300px;"></td>
                                                    <td>Special Trend For Books</td>
                                                    <td>Online<span>Book</span> Store</td>
                                                    <td>Shop now!</td>
    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'product_type', 
                    name: 'product_type',
                        class: 'text-center info', searchable: true, orderable: false, width: '50px'  
                },
                { data: 'product_cate_name', 
                    name: 'product_cate_name',
                        class: 'text-center info', searchable: true, orderable: false, width: '50px'  
                },
                { data: 'product_name', 
                    name: 'product_name',
                        class: 'text-left info', searchable: true, orderable: false, width: '30%'  
                },
                { data: 'product_more', 
                    name: 'product_more',
                        class: 'text-left info', searchable: true, orderable: false, width: '40%'  
                },
        ...
        // ปุ่ม - ด้านซ้าย
        $('#'+tbl_id+'_length').append(button_add+button_update+button_delete);
        ...
        $(document).on('keyup change', 'input.sort', function(){
            window.update_sort(route,token,'cag_product','product_id','product_sort',$(this));
        });
        //Update Active
        $(document).on('click', 'button.active', function(){
            window.update_active(route,token,'cag_product','product_id','product_active',$(this));
        });
