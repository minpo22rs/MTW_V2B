                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="wizardb">
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$ref_id.'/property')}}" method="POST">
                                                        ...
                                                        <fieldset>
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('property_active') == '1' ? 'checked' : (!old('property_active') ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{  old('property_active') && old('property_active') == '0' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    value="{{ old('property_sort') }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">Property <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="property_content" type="text" class="form-control required" data-toggle="tooltip" value="{{ old('property_content') }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">คุณสมบัติ <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="property_content_th" type="text" class="form-control required" data-toggle="tooltip" value="{{ old('property_content_th') }}">
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
