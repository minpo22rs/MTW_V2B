                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="wizardb">
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$ref_id.'/image/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('image_active') == '1' ? 'checked' : ($rec->image_active == '1' ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('image_active') == '0' ? 'checked' : ($rec->image_active == '0' ? 'checked' : '') }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    value="{{ old('image_sort') ? old('image_sort') : $rec->image_sort }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="ref_color_id" class="form-control">
                                                                        {!! \App\Model\front_shop::color_option_html( (old('ref_color_id') ? old('ref_color_id') : $rec->ref_color_id ),$rec->ref_product_id,'Select' ) !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    src="{{ url('storage/app/public/image/product/'.$rec->image_img_name)  }}">
                                                                    <input name="image_img_name" type="file"  class="form-control img" data-toggle="tooltip" data-original-title="เลือกไฟล์ภาพจากในเครื่อง ขนาดภาพ 1600 x 57px เพื่อให้ภาพแสดงผลได้ถูกต้อง" data-placement="left"
                                                                    value="{{ old('image_img_name') ? old('image_img_name') : $rec->image_img_name }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
