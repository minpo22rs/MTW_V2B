                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="wizardb">
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$ref_id.'/color/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('color_active') == '1' ? 'checked' : ($rec->color_active == '1' ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('color_active') == '0' ? 'checked' : ($rec->color_active == '0' ? 'checked' : '') }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    value="{{ old('color_sort') ? old('color_sort') : $rec->color_sort }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="ref_master_color_id" class="form-control">
                                                                        {!! \App\Model\master::color_option_html( (old('ref_master_color_id') ? old('ref_master_color_id') : $rec->ref_master_color_id ),'Select' ) !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </fieldset>
