                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('product_active') == 1 ? 'checked' : ($rec->product_active == '1' ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{  old('product_active') && old('product_active') == 0 ? 'checked' : ($rec->product_active == '0' ? 'checked' : '') }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    value="{{ old('product_sort') ? old('product_sort') : $rec->product_sort }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="product_type" class="form-control">
                                                                        {!! \App\Model\front_shop::product_type_option_html( (old('product_type') ? old('product_type') : $rec->product_type ),'Select')  !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="ref_category_id" class="form-control">
                                                                        {!! \App\Model\front_shop::category_option_html( (old('ref_category_id') ? old('ref_category_id') : $rec->ref_category_id ),'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_name" type="text" class="form-control" value="{{ old('product_name') ? old('product_name') : $rec->product_name }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="product_detail" type="text" class="form-control" >{{ old('product_detail') ? old('product_detail') : $rec->product_detail }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="product_ingredients" type="text" class="form-control">{{ old('product_ingredients') ? old('product_ingredients') : $rec->product_ingredients }}</textarea>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_name_th" type="text" class="form-control" value="{{ old('product_name_th') ? old('product_name_th') : $rec->product_name_th }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="product_detail_th" type="text" class="form-control" >{{ old('product_detail_th') ? old('product_detail_th') : $rec->product_detail_th }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="product_ingredients_th" type="text" class="form-control">{{ old('product_ingredients_th') ? old('product_ingredients_th') : $rec->product_ingredients_th }}</textarea>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <h3>More Detail</h3>
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_normal_price" type="text" class="form-control" value="{{ old('product_normal_price') ? old('product_normal_price') : $rec->product_normal_price }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_discount_price" type="text" class="form-control" value="{{ old('product_discount_price') ? old('product_discount_price') : $rec->product_discount_price }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="product_attribute" class="form-control">
                                                                        {!! \App\Model\master::attribute_option_html(( old('product_attribute') ? old('product_attribute') : $rec->product_attribute ),'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_value" type="text" class="form-control" value="{{ old('product_value') ? old('product_value') : $rec->product_value }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_weight" type="text" class="form-control" value="{{ old('product_weight') ? old('product_weight') : $rec->product_weight }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_width" type="text" class="form-control" value="{{ old('product_width') ? old('product_width') : $rec->product_width }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_long" type="text" class="form-control" value="{{ old('product_long') ? old('product_long') : $rec->product_long }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_height" type="text" class="form-control" value="{{ old('product_height') ? old('product_height') : $rec->product_height }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <h3>Meta</h3>
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="product_meta_title" type="text" class="form-control">{{ old('product_meta_title') ? old('product_meta_title') : $rec->product_meta_title }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="product_meta_keyword" type="text" class="form-control">{{ old('product_meta_keyword') ? old('product_meta_keyword') : $rec->product_meta_keyword }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea name="product_meta_description" type="text" class="form-control">{{ old('product_meta_description') ? old('product_meta_description') : $rec->product_meta_description }}</textarea>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
