                                                ...
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">หมวดหมู่สินค้า <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="cate_name" type="text" class="form-control" value="{{ old('cate_name') ? old('cate_name') : $rec->cate_name }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="cate_remark" type="text" class="form-control" value="{{ old('cate_remark') ? old('cate_remark') : $rec->cate_remark }}" >
                                                                </div>
                                                            </div>
                                                            <br>
                                                        </fieldset>
