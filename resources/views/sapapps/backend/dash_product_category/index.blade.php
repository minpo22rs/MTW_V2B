    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'cate_remark', 
                    name: 'cate_remark',
                        class: 'text-left success', searchable: true, orderable: false, width: '70%'  
                },
                { data: 'cate_created_at', 
                    name: 'cate_created_at',
                        class: 'text-center', searchable: true, orderable: false, width: '100px'  
                },
                { data: 'cate_created_at_ref_user_id', 
                    name: 'cate_created_at_ref_user_id',
                        class: 'text-left info', searchable: true, orderable: false, width: '100px'  
                },
                { data: 'cate_updated_at', 
                    name: 'cate_updated_at',
                        class: 'text-left info', searchable: true, orderable: false, width: '100px'  
                },
                { data: 'cate_updated_at_ref_user_id', 
                    name: 'cate_updated_at_ref_user_id',
                        class: 'text-left info', searchable: true, orderable: false, width: '100px'  
                }     
            ],
            aaSorting: sorting,
