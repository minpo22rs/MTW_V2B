                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">สินค้า</a>
                                    </li>
                            ...
                            <div class="bs-stepper-header">
                                <div class="step" data-target="#account-details-vertical" role="tab" id="account-details-vertical-trigger">
                                    <button type="button" class="step-trigger">
                                        ...
                                        <span class="bs-stepper-label">
                                            <span class="bs-stepper-title">ข้อมูลสินค้า</span>
                                            <span class="bs-stepper-subtitle">รายละเอียดของสินค้า</span>
                                        </span>
                                    </button>
                                </div>
                                <div class="step" data-target="#personal-info-vertical" role="tab" id="personal-info-vertical-trigger">
                                    <button type="button" class="step-trigger">
                                        ...
                                        <span class="bs-stepper-label">
                                            <span class="bs-stepper-title">ข้อมูลราคาสินค้า</span>
                                ...
                                <div class="step" data-target="#address-step-vertical" role="tab" id="address-step-vertical-trigger">
                                    <button type="button" class="step-trigger">
                                        ...
                                        <span class="bs-stepper-label">
                                            <span class="bs-stepper-title">รูปภาพสินค้า</span>
                            ...
                            <div class="bs-stepper-content">
                                <div id="account-details-vertical" class="content" role="tabpanel" aria-labelledby="account-details-vertical-trigger">
                                    <div class="content-header">
                                        ...
                                        <small class="text-muted">กรอกรายละเอียดสินค้า</small>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-category">ประเภทสินค้า</label>
                                            <select class="form-select" name="category" id="vertical-category">
                                                {!! \App\Model\dashboard::category_option_html(( old('category') ? old('category') : $rec->category),'Select','product') !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-product-name">ชื่อสินค้า</label>
                                            <input type="text" name="product_name" id="vertical-product-name" class="form-control" value="{{ old('product_name') ? old('product_name') : $rec->product_name }}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-short-descrip">รายละเอียดของสินค้าโดยย่อ</label>
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-ful-descrip">รายละเอียดของสินค้า</label>
                                ...
                                <div id="personal-info-vertical" class="content" role="tabpanel" aria-labelledby="personal-info-vertical-trigger">
                                    <div class="content-header">
                                        <h5 class="mb-0">ข้อมูลราคาสินค้า</h5>
                                        <small>กรอกรายละเอียดราคาสินค้า</small>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-unit-price">ราคาสินค้าต่อหน่วย</label>
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-sale-price">ราคาขายสินค้า</label>
                                ...
                                <div id="address-step-vertical" class="content" role="tabpanel" aria-labelledby="address-step-vertical-trigger">
                                    <div class="content-header">
                                        ...
                                        <small>ลงรูปภาพสินค้า</small>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <img src="{{ asset('storage/app/public/image/products/'.$rec->product_img_name) }}" title="{{ $rec->product_img_name }}" width="20%">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-cover-img">รูปปกสินค้า</label>
                                            <input type="file" name="product_img_name" id="vertical-cover-img" class="form-control" value="{{ old('product_img_name') ? old('product_img_name') : $rec->product_img_name }}">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary btn-prev">
