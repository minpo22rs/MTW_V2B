                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="product_supplier">
                                                                        {!! \App\Model\dashboard::supplier_option_html(( old('product_supplier') ? old('product_supplier') : $rec->product_supplier) ,'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="product_type">
                                                                        {!! \App\Model\dashboard::type_option_html(( old('product_type') ? old('product_type') : $rec->product_type) ,'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="product_category">
                                                                        {!! \App\Model\dashboard::category_option_html(( old('product_category') ? old('product_category') : $rec->product_category) ,'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_url" type="text" class="form-control" value="{{ old('product_url') ? old('product_url') : $rec->product_url }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="product_ref_admin">
                                                                        {!! \App\Model\dashboard::merchandize_option_html(( old('product_ref_admin') ? old('product_ref_admin') : $rec->product_ref_admin) ,'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="product_attribute">
                                                                        {!! \App\Model\dashboard::attribute_option_html(( old('product_attribute') ? old('product_attribute') : $rec->product_attribute) ,'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_unit_price" type="text" class="form-control" value="{{ old('product_unit_price') ? old('product_unit_price') : $rec->product_unit_price }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_noti_few" type="text" class="form-control" value="{{ old('product_noti_few') ? old('product_noti_few') : $rec->product_noti_few }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_round_use" type="text" class="form-control" value="{{ old('product_round_use') ? old('product_round_use') : $rec->product_round_use }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <h3> ข้อมูลอื่นๆ</h3>
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_open" type="date" class="form-control" value="{{ old('product_open') ? old('product_open') : $rec->product_open }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_end" type="date" class="form-control" value="{{ old('product_end') ? old('product_end') : $rec->product_end }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="product_barcode" type="text" class="form-control" value="{{ old('product_barcode') ? old('product_barcode') : $rec->product_barcode }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    src="{{ url('storage/app/public/image/products/'.$rec->product_img_name)  }}">
                                                                    <input name="product_img_name" type="file"  class="form-control img"
                                                                    value="{{ old('product_img_name') ? old('product_img_name') : $rec->product_img_name }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
