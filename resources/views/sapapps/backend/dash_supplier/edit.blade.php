                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_id" type="text" class="form-control" value="{{ old('supplier_id') ? old('supplier_id') : $rec->supplier_id }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_name" type="text" class="form-control" value="{{ old('supplier_name') ? old('supplier_name') : $rec->supplier_name }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_phone" type="text" class="form-control" value="{{ old('supplier_phone') ? old('supplier_phone') : $rec->supplier_phone }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_email" type="text" class="form-control" value="{{ old('supplier_email') ? old('supplier_email') : $rec->supplier_email }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_website" type="text" class="form-control" value="{{ old('supplier_website') ? old('supplier_website') : $rec->supplier_website }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="assigned_to" type="hidden" value="{!! $rec->assigned_to !!}">
                                                                    <input name="assigned_to" type="text" class="form-control" value="$rec->assigned_to" disabled>
                                                                    <!-- <select class="form-control" name="assigned_to">
                                                                        {!! \App\Model\dashboard::assigned_option_html(( old('assigned_to') ? old('assigned_to') : $rec->assigned_to) ,'Select') !!}
                                                                    </select> -->
                                                                </div>
                                                            </div>
                                                            <br>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="taxpayer_name" type="text" class="form-control" value="{{ old('taxpayer_name') ? old('taxpayer_name') : $rec->taxpayer_name }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="taxpayer_id" type="text" class="form-control" value="{{ old('taxpayer_id') ? old('taxpayer_id') : $rec->taxpayer_id }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <h3> ข้อมูลที่อยู่ </h3>
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_address" type="text" class="form-control" value="{{ old('supplier_address') ? old('supplier_address') : $rec->supplier_address }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_numhome" type="text" class="form-control" value="{{ old('supplier_numhome') ? old('supplier_numhome') : $rec->supplier_numhome }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_swine" type="text" class="form-control" value="{{ old('supplier_swine') ? old('supplier_swine') : $rec->supplier_swine }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_alley" type="text" class="form-control" value="{{ old('supplier_alley') ? old('supplier_alley') : $rec->supplier_alley }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_road" type="text" class="form-control" value="{{ old('supplier_road') ? old('supplier_road') : $rec->supplier_road }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control dynamic" name="supplier_province" id="province_id" data-dependent="district_id">
                                                                        {!! \App\Model\dashboard::province_option_html(( old('supplier_province') ? old('supplier_province') : $rec->supplier_province),'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-control dynamic" name="supplier_district" id="district_id" data-dependent="subdistrict_id">
                                                                        {!! \App\Model\dashboard::district_option_html(( old('supplier_district') ? old('supplier_district') : $rec->supplier_district ),'Select', $rec->supplier_province ) !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <select class="form-control" name="supplier_subdistrict" id="subdistrict_id">
                                                                    {!! \App\Model\dashboard::subdistrict_option_html(( old('supplier_subdistrict') ? old('supplier_subdistrict') : $rec->supplier_subdistrict ),'Select', $rec->supplier_district ) !!}
                                                                </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_postcode" type="text" class="form-control" value="{{ old('supplier_postcode') ? old('supplier_postcode') : $rec->supplier_postcode }}" >
                                                                </div>
                                                            </div>
                                                            <br>
                                                        </fieldset>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="supplier_detail" type="text" class="form-control" value="{{ old('supplier_detail') ? old('supplier_detail') : $rec->supplier_detail }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
