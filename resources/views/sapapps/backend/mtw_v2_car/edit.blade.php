                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">รถยนต์</a>
                                    </li>
                            ...
                            <div class="bs-stepper-header">
                                <div class="step" data-target="#account-details-vertical" role="tab" id="account-details-vertical-trigger">
                                    <button type="button" class="step-trigger">
                                        ...
                                        <span class="bs-stepper-label">
                                            <span class="bs-stepper-title">ข้อมูลรถยนต์</span>
                                            <span class="bs-stepper-subtitle">รายละเอียดของรถยนต์</span>
                                        </span>
                                    </button>
                                </div>
                                <div class="step" data-target="#personal-info-vertical" role="tab" id="personal-info-vertical-trigger">
                                    <button type="button" class="step-trigger">
                                        ...
                                        <span class="bs-stepper-label">
                                            <span class="bs-stepper-title">ข้อมูลราคารถยนต์</span>
                                ...
                                <div class="step" data-target="#address-step-vertical" role="tab" id="address-step-vertical-trigger">
                                    <button type="button" class="step-trigger">
                                        ...
                                        <span class="bs-stepper-label">
                                            <span class="bs-stepper-title">รูปภาพรถยนต์</span>
                            ...
                            <div class="bs-stepper-content">
                                <div id="account-details-vertical" class="content" role="tabpanel" aria-labelledby="account-details-vertical-trigger">
                                    <div class="content-header">
                                        <h5 class="mb-0">ข้อมูลรถยนต์</h5>
                                        <small class="text-muted">กรอกรายละเอียดรถยนต์</small>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-category">ประเภทรถยนต์</label>
                                            <select class="form-select" name="category" id="vertical-category">
                                                {!! \App\Model\dashboard::category_option_html(( old('category') ? old('category') : $rec->category),'Select','car') !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-car-name">ชื่อรถยนต์</label>
                                            <input type="text" name="car_name" id="vertical-car-name" class="form-control" value="{{ old('car_name') ? old('car_name') : $rec->car_name }}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-short-descrip">รายละเอียดของรถยนต์โดยย่อ</label>
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-ful-descrip">รายละเอียดของรถยนต์</label>
                                ...
                                <div id="personal-info-vertical" class="content" role="tabpanel" aria-labelledby="personal-info-vertical-trigger">
                                    <div class="content-header">
                                        <h5 class="mb-0">ข้อมูลราคารถยนต์</h5>
                                        <small>กรอกรายละเอียดราคารถยนต์</small>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-unit-price">ราคารถยนต์ต่อหน่วย</label>
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-sale-price">ราคาขายรถยนต์</label>
                                ...
                                <div id="address-step-vertical" class="content" role="tabpanel" aria-labelledby="address-step-vertical-trigger">
                                    <div class="content-header">
                                        <h5 class="mb-0">รูปภาพรถยนต์</h5>
                                        <small>ลงรูปภาพรถยนต์</small>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <img src="{{ asset('storage/app/public/image/cars/'.$rec->car_img_name) }}" title="{{ $rec->car_img_name }}" width="20%">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-cover-img">รูปปกรถยนต์</label>
                                            <input type="file" name="car_img_name" id="vertical-cover-img" class="form-control" value="{{ old('car_img_name') ? old('car_img_name') : $rec->car_img_name }}">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary btn-prev">
