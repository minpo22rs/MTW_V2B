...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('keyup change', 'input.sort', function(){
            window.update_sort(route,token,'cag_category','category_id','category_sort',$(this));
        });
        //Update Active
        $(document).on('click', 'button.active', function(){
            window.update_active(route,token,'cag_category','category_id','category_active',$(this));
        });
