                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                <input type="radio" name="category_active" value="1" data-bv-field="category_active" 
                                                                                {{ old('category_active') == 1 ? 'checked' : ($rec->category_active == '1' ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                <input type="radio" name="category_active" value="0" data-bv-field="category_active"
                                                                                {{  old('category_active') && old('category_active') == 0 ? 'checked' : ($rec->category_active == '0' ? 'checked' : '') }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="category_sort" type="text" class="form-control" data-toggle="tooltip" data-original-title="ใส่เลขเพื่อเรียงลำดับ 1 - 99" data-placement="left" 
                                                                    value="{{ old('category_sort') ? old('category_sort') : $rec->category_sort }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="category_topic" type="text" class="form-control" value="{{ old('category_topic') ? old('category_topic') : $rec->category_topic }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
