                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                                    ...
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{ old('category_active') == '1' ? 'checked' : (!old('category_active') ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                ...
                                                                                {{  old('category_active') && old('category_active') == '0' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="category_topic" type="text" class="form-control" value="{{ old('category_topic') }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
