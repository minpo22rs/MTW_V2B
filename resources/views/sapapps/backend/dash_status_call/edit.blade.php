                                                ...
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">สถานะการโทร <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="sts_text" type="text" class="form-control" value="{{ old('sts_text') ? old('sts_text') : $rec->sts_text }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">ประเภทสถานะ <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="sts_type">
                                                                        {!! \App\Model\dashboard::status_call_type_option_html(( old('sts_type') ? old('sts_type') : $rec->sts_type) ,'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <br>
