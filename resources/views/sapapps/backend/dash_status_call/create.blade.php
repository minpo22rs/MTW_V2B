                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="sts_text" type="text" class="form-control" value="{{ old('sts_text') }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">ประเภทสถานะ </label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="sts_type">
                                                                        {!! \App\Model\dashboard::status_call_type_option_html(( old('sts_type')),'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <br>
