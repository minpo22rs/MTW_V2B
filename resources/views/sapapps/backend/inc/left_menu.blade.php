        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template-dark/index.html"><span class="brand-logo">
                        ...
                        <h2 class="brand-text">MTW-ASIA V.22222</h2>
                    </a></li>
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning rounded-pill ms-auto me-1">2</span></a>
                    <ul class="menu-content">
                        <li class="" id="menu-analytics"><a class="d-flex align-items-center" href="dashboard-analytics.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Analytics</span></a>
                        </li>
                ...
                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">สินค้า &amp; บริการ</span><i data-feather="more-horizontal"></i>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="miss">นางงาม</span></a>
                    <ul class="menu-content">
                ...
                <!--  -->
                <li class=" navigation-header"><span data-i18n="System">การสั่งซื้อ</span><i data-feather="more-horizontal"></i>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="shopping-cart"></i><span class="menu-title text-truncate" data-i18n="miss">รายการสั่งซื้อ</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="app-invoice-list.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">รายการสั่งซื้อทั้งหมด</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="app-invoice-add.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Add">รายการสั่งซื้อที่สำเร็จ</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="app-invoice-add.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Add">รายการสั่งซื้อที่ยกเลิก</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="list"></i><span class="menu-title text-truncate" data-i18n="miss">ประวิติการสั่งซื้อ</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="app-invoice-list.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">ประวิติการสั่งซื้อทั้งหมด</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="app-invoice-add.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Add">ประวิติการสั่งซื้อที่สำเร็จ</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="app-invoice-add.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Add">ประวิติการสั่งซื้อที่ยกเลิก</span></a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="app-email.html"><i data-feather="briefcase"></i><span class="menu-title text-truncate" data-i18n="users">ออกเอกสารอินวอยซ์</span></a>
                </li>
                <!--  -->
                <li class=" navigation-header"><span data-i18n="User Interface">สืทธิ์การเข้าถึง</span><i data-feather="more-horizontal"></i>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="app-email.html"><i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="users">ผู้เข้าใช้งานในระบบ</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="app-email.html"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="merchandizes">รายชื่อร้านค้า</span></a>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="app-email.html"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="admin">ผู้ดูแลระบบ</span></a>
                </li>
                <!--  -->
                <li class=" navigation-header"><span data-i18n="System">ตั้งค่า / ระบบ</span><i data-feather="more-horizontal"></i>
                </li>
            </ul>
        </div>
    </div>
