    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'type_created_at', 
                    name: 'type_created_at',
                        class: 'text-center', searchable: true, orderable: false, width: '100px'  
                },
                { data: 'type_created_at_ref_user_id', 
                    name: 'type_created_at_ref_user_id',
                        class: 'text-left info', searchable: true, orderable: false, width: '100px'  
                },
                { data: 'type_updated_at', 
                    name: 'type_updated_at',
                        class: 'text-left info', searchable: true, orderable: false, width: '100px'  
                },
                { data: 'type_updated_at_ref_user_id', 
                    name: 'type_updated_at_ref_user_id',
                        class: 'text-left info', searchable: true, orderable: false, width: '100px'  
                }     
            ],
            aaSorting: sorting,
