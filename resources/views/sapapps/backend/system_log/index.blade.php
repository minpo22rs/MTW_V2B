...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            ajax: ajax,
            columns: [
                { data: 'backend_login_id', 
                    name: 'backend_login_id', 
                        class: 'text-center', searchable: true, orderable: true, width: '50px' 
                },
                { data: 'backend_login_status', 
                    name: 'backend_login_status',
                        class: 'text-center success', searchable: true, orderable: false, width: '50px'  
                },
                { data: 'backend_login_username', 
                    name: 'backend_login_username',
                        class: 'text-center', searchable: true, orderable: false, width: '50px'  
                },
                { data: 'backend_login_browser', 
                    name: 'backend_login_browser',
                        class: 'text-left info', searchable: true, orderable: false, width: '50px'  
                },
                { data: 'backend_login_detail', 
                    name: 'backend_login_detail',
                        class: 'text-left info', searchable: true, orderable: false, width: '100%'  
                },
                { data: 'backend_login_visitor', 
                    name: 'backend_login_visitor',
                        class: 'text-left info', searchable: true, orderable: false, width: '50px'  
                },           
                { data: 'backend_login_created_at', 
                    name: 'backend_login_created_at',
