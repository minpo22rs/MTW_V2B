    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'attribute_topic', 
                    name: 'attribute_topic',
                        class: 'text-left info', searchable: true, orderable: false, width: '100%'  
                },
                { data: 'attribute_created_at', 
                    name: 'attribute_created_at',
                        class: 'text-left info', searchable: true, orderable: false, width: '100px'  
                },
                { data: 'attribute_updated_at', 
        ...
        $(document).on('keyup change', 'input.sort', function(){
            window.update_sort(route,token,'cag_attribute','attribute_id','attribute_sort',$(this));
        });
        //Update Active
        $(document).on('click', 'button.active', function(){
            window.update_active(route,token,'cag_attribute','attribute_id','attribute_active',$(this));
        });
