                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="form-radio">
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                <input type="radio" name="attribute_active" value="1" data-bv-field="attribute_active" 
                                                                                {{ old('attribute_active') == 1 ? 'checked' : ($rec->attribute_active == '1' ? 'checked' : '') }}>
                                                                                <i class="helper"></i>On
                                                                            </label>
                                                                        </div>
                                                                        <div class="radio radiofill radio-primary radio-inline">
                                                                            <label>
                                                                                <input type="radio" name="attribute_active" value="0" data-bv-field="attribute_active"
                                                                                {{  old('attribute_active') && old('attribute_active') == 0 ? 'checked' : ($rec->attribute_active == '0' ? 'checked' : '') }}>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="attribute_sort" type="text" class="form-control" data-toggle="tooltip" data-original-title="ใส่เลขเพื่อเรียงลำดับ 1 - 99" data-placement="left" 
                                                                    value="{{ old('attribute_sort') ? old('attribute_sort') : $rec->attribute_sort }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">Attibute <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="attribute_topic" type="text" class="form-control" value="{{ old('attribute_topic') ? old('attribute_topic') : $rec->attribute_topic }}" >
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                    </form>
