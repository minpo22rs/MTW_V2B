                        ...
                        <div class="bs-stepper vertical vertical-wizard-example">
                            ...
                            <div class="bs-stepper-content">
                                <div id="account-details-vertical" class="content" role="tabpanel" aria-labelledby="account-details-vertical-trigger">
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" name="att_name" id="vertical-product-name" class="form-control" value="{{ old('att_name') ? old('att_name') : $rec->att_name }}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <select class="form-select dynamic" name="att_province" id="province_id" data-dependent="district_id">
                                                {!! \App\Model\dashboard::province_option_html(( old('att_province') ? old('att_province') : $rec->att_province),'Select') !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <select class="form-select dynamic" name="att_district" id="district_id" data-dependent="subdistrict_id">
                                                {!! \App\Model\dashboard::district_option_html(( old('att_district') ? old('att_district') : $rec->att_district),'Select',$rec->att_province) !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            {!! \App\Model\dashboard::subdistrict_option_html(( old('att_subdistrict') ? old('att_subdistrict') : $rec->att_subdistrict),'Select',$rec->att_district) !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" name="location" id="vertical-product-name" class="form-control" value="{{ old('location') ? old('location') : $rec->location }}">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                ...
                                <div id="address-step-vertical" class="content" role="tabpanel" aria-labelledby="address-step-vertical-trigger">
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <img src="{{ asset('storage/app/public/image/attractions/'.$rec->cover_img_name) }}" title="{{ $rec->cover_img_name }}" width="20%">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-cover-img">รูปปกสถานที่ท่องเที่ยว</label>
                                            <input type="file" name="cover_img_name" id="vertical-cover-img" class="form-control" value="{{ old('cover_img_name') ? old('cover_img_name') : $rec->cover_img_name }}">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary btn-prev">
