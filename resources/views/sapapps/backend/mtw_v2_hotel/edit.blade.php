                        ...
                        <div class="bs-stepper vertical vertical-wizard-example">
                            ...
                            <div class="bs-stepper-content">
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <select class="form-select" name="category" id="vertical-category">
                                                {!! \App\Model\dashboard::category_option_html(( old('category') ? old('category') : $rec->category),'Select','hotel') !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" name="hotel_name" id="vertical-hotel-name" class="form-control" value="{{ old('hotel_name') ? old('hotel_name') : $rec->hotel_name }}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                ...
                                <div id="personal-info-vertical" class="content" role="tabpanel" aria-labelledby="personal-info-vertical-trigger">
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-sale-price">ราคาขายโรงแรม</label>
                                ...
                                <div id="address-step-vertical" class="content" role="tabpanel" aria-labelledby="address-step-vertical-trigger">
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <img src="{{ asset('storage/app/public/image/hotels/'.$rec->hotel_img_name) }}" title="{{ $rec->hotel_img_name }}" width="20%">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            <label class="form-label" for="vertical-cover-img">รูปปกโรงแรม</label>
                                            <input type="file" name="hotel_img_name" id="vertical-cover-img" class="form-control" value="{{ old('hotel_img_name') ? old('hotel_img_name') : $rec->hotel_img_name }}">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary btn-prev">
