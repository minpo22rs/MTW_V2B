                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <select class="form-select" name="category" id="vertical-category">
                                                {!! \App\Model\dashboard::category_option_html(( old('category')),'Select','car') !!}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" name="car_name" id="vertical-car-name" class="form-control" value="{!! old('car_name') !!}">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                ...
                                <div id="address-step-vertical" class="content" role="tabpanel" aria-labelledby="address-step-vertical-trigger">
                                    ...
                                    <div class="row form-group">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="file" name="car_img_name" id="vertical-cover-img" class="form-control" value="{!! old('car_img_name') !!}">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <button type="button" class="btn btn-primary btn-prev">
