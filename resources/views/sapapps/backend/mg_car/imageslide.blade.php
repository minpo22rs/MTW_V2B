                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">รถยนต์</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">{{$car}}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="#">รูปภาพรถยนต์</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">เพิ่มรูปภาพรถยนต์</h4>
                        </div>
                        <div class="card-body">
                            <form class="form form-horizontal" action="{{url('/backend/'.$url.'/'.$id.'/imageslide')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-10">
                                        <div class="mb-1 row">
                                            <div class="col-sm-12">
                                                <label class="col-form-label" for="slide_img_name">รูปภาพรถยนต์</label>
                                            </div>
                                            <div class="col-sm-12">
