        ...
        <div class="main-body">
            <div class="page-wrapper">
                                        ...
                                        <table id="data-table_{{$url}}" class="table table-bordered table-hover table-striped table-condensed nowrap">
                                            <thead>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Manage</th>
                                                    <th>Info</th>
                                                    <th>สถานะการโทรล่าสุด</th>
                                                    <th>วันที่บันทึกสถานะล่าสุด</th>
                                                    <th>รหัสซัพลูกค้า</th>
                                                    <th>ชื่อ</th>
                                                    <th>นามสกุล</th>
                                                    <th>เบอร์โทรศัพท์</th>
                                                    <th>แหล่งที่มาข้อมูล</th>
                                                    <th>พนักงาน</th>
                                                </tr>
                                            </thead>
                                        </table>
                ...
                <div class="page-header card">
                    <div class="card-block">
                        <h5 class="m-b-10">แจกแจงรายชื่อให้ Sale</h5>
                        <form action="/backend/{!! $url !!}/spread_customer" method="post">
                            {{csrf_field()}}
                            <button class="btn btn-grd-warning">กระจายทั้งหมด</button>
                        </form>
                        <hr>
                        <form action="/backend/{!! $url !!}/spread_customer_new" method="post">
                            {{csrf_field()}}
                            <button class="btn btn-grd-info">กระจายรายชื่อที่นำเข้าล่าสุด</button>
                        </form>
                    </div>
                </div>
                @endif
    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                { data: 'customer_id', 
                    name: 'customer_id', 
                        class: 'text-center', searchable: true, orderable: true, width: '20px' 
                },
                { data: 'manage', 
                    name: 'manage',
                        class: 'text-center', searchable: true, orderable: false, width: '70px'  
                },
                { data: 'info', 
                    name: 'info',
                        class: 'text-center', searchable: true, orderable: false, width: '70px'  
                },
                { data: 'last_result_call', 
                    name: 'last_result_call',
                        class: 'text-center', searchable: true, orderable: false, width: '70px'  
                },
                { data: 'last_result_call_date', 
                    name: 'last_result_call_date',
                        class: 'text-center', searchable: true, orderable: false, width: '70px'  
                },
                { data: 'customer_mem_id', 
                    name: 'customer_mem_id',
                        class: 'text-left info', searchable: true, orderable: false, width: '15%'  
                },
                { data: 'customer_name', 
                    name: 'customer_name',
                        class: 'text-left success', searchable: true, orderable: false, width: '25%'  
                },
                ...
                { data: 'customer_phone', 
                    name: 'customer_phone',
                        class: 'text-left success', searchable: true, orderable: false, width: '10%'  
                },
