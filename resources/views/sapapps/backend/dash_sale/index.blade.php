    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'manage', 
                    name: 'manage',
                        class: 'text-center', searchable: false, orderable: false, width: '40px'  
                },
                { data: 'so_status', 
                    name: 'so.so_status',
                ...
                { data: 'so_sum_price', 
                    name: 'so.so_sum_price',
                        class: 'text-left', searchable: true, orderable: false, width: '10%'  
                },
                { data: 'so_date', 
                    name: 'so.so_date',
                        class: 'text-left info', searchable: true, orderable: false, width: '10%'  
                ...
                { data: 'so_created_at_ref_user_id', 
                    name: 'so_created_at_ref_user_id',
                        class: 'text-left info', searchable: true, orderable: false, width: '10%'  
                },
            ],
            aaSorting: sorting,
        ...
        // ปุ่ม - ด้านซ้าย
        $('#'+tbl_id+'_length').append(button_delete);
