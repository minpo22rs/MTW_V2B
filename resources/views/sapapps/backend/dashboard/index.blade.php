                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        <div class="card card-congratulations">
                            <div class="card-body text-center">
                                <img src="{!! asset('public/backend/app-assets/images/elements/decore-left.png') !!}" class="congratulations-img-left" alt="card-img-left" />
                                <img src="{!! asset('public/backend/app-assets/images/elements/decore-right.png') !!}" class="congratulations-img-right" alt="card-img-right" />
                                ...
                                <ul class="timeline ms-50">
                                    <li class="timeline-item">
                                        ...
                                        <div class="timeline-event">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <img class="me-1" src="{!! asset('public/backend/app-assets/images/icons/json.png') !!}" alt="data.json" height="23" />
                                        ...
                                        <div class="timeline-event">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar me-50">
                                                    <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-9.jpg') !!}" alt="Avatar" width="38" height="38" />
                                                </div>
                                                <div class="more-info">
                                        ...
                                        <div class="timeline-event">
                                            ...
                                            <div class="avatar-group">
                                                <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Billy Hopkins" class="avatar pull-up">
                                                    <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-9.jpg') !!}" alt="Avatar" width="33" height="33" />
                                                </div>
                                                <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Amy Carson" class="avatar pull-up">
                                                    <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-6.jpg') !!}" alt="Avatar" width="33" height="33" />
                                                </div>
                                                <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Brandon Miles" class="avatar pull-up">
                                                    <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-8.jpg') !!}" alt="Avatar" width="33" height="33" />
                                                </div>
                                                <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Daisy Weber" class="avatar pull-up">
                                                    <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-7.jpg') !!}" alt="Avatar" width="33" height="33" />
                                                </div>
                                                <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom" title="Jenny Looper" class="avatar pull-up">
                                                    <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-20.jpg') !!}" alt="Avatar" width="33" height="33" />
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                        ...
                        <div class="card card-app-design">
                            <div class="card-body">
                                ...
                                <div class="design-group pt-25">
                                    ...
                                    <div class="avatar">
                                        <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-9.jpg') !!}" width="34" height="34" alt="Avatar" />
                                    </div>
                                    <div class="avatar bg-light-danger">
                                        <div class="avatar-content">PI</div>
                                    </div>
                                    <div class="avatar">
                                        <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-14.jpg') !!}" width="34" height="34" alt="Avatar" />
                                    </div>
                                    <div class="avatar">
                                        <img src="{!! asset('public/backend/app-assets/images/portrait/small/avatar-s-7.jpg') !!}" width="34" height="34" alt="Avatar" />
                                    </div>
...
<script src="{!! asset('public/backend/app-assets/vendors/js/extensions/moment.min.js') !!}"></script>
...
<script src="{!! asset('public/backend/app-assets/js/scripts/pages/app-invoice-list.js') !!}"></script>
<!-- END: Page JS-->
