    ...
    $(document).ready(function(){
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'stock_value', 
                    name: 'stock_value',
                        class: 'text-left success', searchable: true, orderable: false, width: '50%'  
                },        
                { data: 'stock_add', 
                    name: 'stock_add',
                        class: 'text-left success', searchable: true, orderable: false, width: '50%'  
        ...
        //Update Sort
        $(document).on('keyup change', 'input.stock', function(){
            window.update_sort(route,token,'cag_product','product_id','product_stock',$(this));
        });
