                                                ...
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">Stock Value <span>: {!! $rec->stock_value !!} </span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="stock_value" type="text" class="form-control" data-toggle="tooltip" data-original-title="ใส่เลขเพื่อเรียงลำดับ 1 - 99" data-placement="left" 
