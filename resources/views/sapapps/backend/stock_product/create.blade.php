                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="ref_product_id" class="form-control dynamic" id="ref_product_id" data-dependent="ref_color_id">
                                                                        {!! \App\Model\front_shop::product_option_html(( old('ref_product_id')),'Select') !!}
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                <select name="ref_color_id" class="form-control" id="ref_color_id">
