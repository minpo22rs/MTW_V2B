...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var ajax = {
            "url": '{!! route($url.'.datatables_agent') !!}', 
            "type": "POST",
            'headers': {
        ...
        var table = $('#'+tbl_id).DataTable({
            ...
            columns: [
                ...
                { data: 'cost_target', 
                    name: 'cost_target',
                        class: 'text-center', searchable: true, orderable: false, width: '8%'  
                },
                { data: 'role', 
                    name: 'role',
                        class: 'text-center', searchable: true, orderable: false, width: '15%'  
                },
                { data: 'username', 
                    name: 'username',
        ...
        // ปุ่ม - ด้านซ้าย
        $('#'+tbl_id+'_length').append(button_update);
        ...
        $(document).on('keyup change', 'input.sort', function(){
            window.update_sort(route,token,'account_admin','id','cost_target',$(this));
        });
