                                                    ...
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="attribute_name" type="text" class="form-control" value="{{ old('attribute_name') }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="attribute_remark" type="text" class="form-control" value="{{ old('attribute_remark') }}" >
                                                                </div>
                                                            </div>
                                                            <br>
                                                        </fieldset>
