                                                ...
                                                <section>
                                                    <form class="wizard-form" id="verticle-wizard-validate" action="{{url('/backend/'.$url.'/'.$id)}}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <label class="block">หน่วยนับสินค้า <span class="text-danger ">*</span></label>
                                                                </div>
                                                                <div class="col-sm-12">
                                                                    <input name="attribute_name" type="text" class="form-control" value="{{ old('attribute_name') ? old('attribute_name') : $rec->attribute_name }}" >
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input name="attribute_remark" type="text" class="form-control" value="{{ old('attribute_remark') ? old('attribute_remark') : $rec->attribute_remark }}" >
                                                                </div>
                                                            </div>
                                                            <br>
                                                        </fieldset>
