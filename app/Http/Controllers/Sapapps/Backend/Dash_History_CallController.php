...
class Dash_History_CallController extends Controller
{
    public function __construct()
    {
        $this->url  = 'dash_history_call';
        parent::__construct($this->url);
        $this->path_file .= '.dash_history_call';
        $this->menu = 'ประวัติการโทรทั้งหมด';//\App\Model\Menu::get_menu_name($this->url)['menu'];
    ...
    {
        $tbl = \App\Model\dashboard::datatables_history_call(@$request->all());
