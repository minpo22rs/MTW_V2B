...
class Dash_History_Call_CancelController extends Controller
{
    public function __construct()
    {
        $this->url  = 'dash_history_call_cancel';
        parent::__construct($this->url);
        $this->path_file .= '.dash_history_call_cancel';
        $this->menu = 'ยกเลิกการติดต่อ';//\App\Model\Menu::get_menu_name($this->url)['menu'];
    ...
    {
        $tbl = \App\Model\dashboard::datatables_history_call(@$request->all(),'cancel');
