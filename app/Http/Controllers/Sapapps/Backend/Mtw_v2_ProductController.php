...
class Mtw_v2_ProductController extends Controller
{
    public function __construct()
    {
        $this->url = 'mtw_v2_product';
        parent::__construct($this->url);
        $this->path_file .= '.mtw_v2_product';
    ...
    public function store(Request $request)
    {
        ...
        try {
            $data = [];
            $columns = DB::getSchemaBuilder()->getColumnListing('mtw_v2_product');
            ...
            if (@$product_img_name) {
                ...
                if ($file) {
                    ...
                    DB::table('mtw_v2_product')->where('id', $img_id)->update($data_img);
