...
class Dash_HistoryController extends Controller
{
    public function __construct()
    {
        $this->url  = 'dash_history';
        parent::__construct($this->url);
        $this->path_file .= '.dash_history';
        $this->menu = 'ประวัติการสั่งซื้อทั้งหมด';//\App\Model\Menu::get_menu_name($this->url)['menu'];
    ...
    {
        $tbl = \App\Model\dashboard::datatables_history(@$request->all());
        ...
        $DBT->editColumn('manage', function($col){
            ...
            $html = '<a href="'.url('backend/dash_history/'.$col->id.'/info').'" class="text-danger"><button class="btn btn-sm btn-grd-info">
