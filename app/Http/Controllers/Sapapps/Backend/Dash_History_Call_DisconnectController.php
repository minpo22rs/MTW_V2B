...
class Dash_History_Call_DisconnectController extends Controller
{
    public function __construct()
    {
        $this->url  = 'dash_history_call_disconnect';
        parent::__construct($this->url);
        $this->path_file .= '.dash_history_call_disconnect';
        $this->menu = 'ยังติดต่อไม่ได้';//\App\Model\Menu::get_menu_name($this->url)['menu'];
    ...
    {
        $tbl = \App\Model\dashboard::datatables_history_call(@$request->all(),'disconnect');
